...
#ifndef HULL_COORDINATE_H
#define HULL_COORDINATE_H
...
namespace hull {
    ...
    inline float normSquared(const Coordinate &c) { return dot(c, c); }

    inline float norm(const Coordinate &c) { return sqrtf(dot(c, c)); }
